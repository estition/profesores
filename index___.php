...
$result = mysqli_query($link, $sql) or die("Invalid query 1: " . mysqli_error($link));
...
$result = mysqli_query($link, $sql) or die("Invalid query 2: " . mysqli_error($link));
...
IF ($_REQUEST['action'] == 'INSERT') {
	...
	$result = mysqli_query($link, $sql) or die("Invalid query 3: " . mysqli_error($link));
...
IF ($_REQUEST['action'] == 'DELETE') {
	...
	//print '###############'.$sql;
	mysqli_query($link, $sql) or die("Invalid query: 7" . mysqli_error($link));
...
//print $sql;
$result = mysqli_query($link, $sql) or die("Invalid query: 8" . mysqli_error($link));
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
	if ($first_client == "") {
...
$result = mysqli_query($link, $sql) or die("Invalid query: 9" . mysqli_error($link));
//print $sql;
...
$result = mysqli_query($link, $sql) or die("Invalid query: 10" . mysqli_error($link));
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
...
$result = mysqli_query($link, $sql) or die("Invalid query: 11" . mysqli_error($link));
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
	if ($bg == "#FFFFFF") {
		$bg = "#B6C5F2";
	} else {
...
$day = date('l', strtotime($year . '-' . $month . '-' . 1));
	...
	for ($j = 0; $j < $days; $j++) {
		...
		if (date('D', strtotime($year . '-' . $month . '-' . ($j + 1))) == "Sat") {
			...
			$result = mysqli_query($link, $sql) or die("Invalid query: 12" . mysqli_error($link));
			if ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				$color = "#ff9900";
			} else {
				$color = "#B6C5F2";
		...
		//print $sql;
		$result = mysqli_query($link, $sql) or die("Invalid query: 13" . mysqli_error($link));
		if ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				$color = "#FFE6BF";
		}
...
$result = mysqli_query($link, $sql) or die("Invalid query: 14" . mysqli_error($link));
