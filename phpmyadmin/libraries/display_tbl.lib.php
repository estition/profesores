...
<td>
   ...
   <td>
        <?php //<form> for keep the form alignment of button < and <<?php >
        <form action="none">
...
function PMA_displayTableBody(&$dt_result, &$is_display, $map, $analyzed_sql) {
    ...
    // loic1: use 'PMA_mysqli_fetch_array' rather than 'PMA_mysqli_fetch_row'
    ...
    while ($row = PMA_DBI_fetch_row($dt_result)) {
        ...
        for ($i = 0; $i < $fields_cnt; ++$i) {
            ...
            //  b l o b
                ...
                // loic1 : PMA_mysqli_fetch_fields returns BLOB in place of
