...
<?php } ?>
<td class="<?php echo $style ?>"><a href="groups.php?a=view&recid=<?php echo $i ?>">View</a></td>
<td class="<?php echo $style ?>"><a href="groups.php?a=edit&recid=<?php echo $i ?>">Edit</a></td>
<td class="<?php echo $style ?>"><a href="groups.php?a=del&recid=<?php echo $i ?>">Delete</a></td>
</tr>
<?php }
