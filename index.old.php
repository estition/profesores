								...
								<tr>
									...
									<td>
										...
										<?php
											...
											?>
											<option value="1" <?php echo $selected?> >1 hour</option>
											<?php
											if ($class_length == 1.5) {
												$selected = "selected";
											} else {
											...
											?>
											<option value="1.5" <?php echo $selected?>>1 1/2 hours</option>
											<?php
											if ($class_length == 2) {
												$selected = "selected";
											} else {
											...
											?>
											<option value="2" <?php echo $selected?>>2 hours</option>
											<?php
											if ($class_length == 2.5) {
												$selected = "selected";
											} else {
											...
											?>
											<option value="2.5" <?php echo $selected?>>2 1/2 hours</option>
										</select>
									</td>
								</tr>
								<tr>
