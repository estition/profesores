	...
	$tag8[] = $tag;
	 break;
		...
		$tag8 = implode(",",$tag8); 
			...
			$sql = "insert into users (user_id, password, is_admin, is_active, changePassword, first, country, mobile, email,  CURRICULUM, spanish_level,  metro, startdate, enddate, ZONES, CERTIFICATION, Exam_Prep, CLASS_TYPE, GENDER,  AVAILABILITY) values";
                          ...
                          <select multiple="multiple" id="my-select" name="my-select1[]">
                            ...
                            <optgroup label='Gender'>
                             ...
                             <optgroup label='AVAILABILITY'>
                              <option value='5.FEBRUARY'<?php is_selected1('FEBRUARY', $availability); ?>>FEBRUARY</option>
                            ...
                            <optgroup label='Spanish'>
                              ...
                              <option value='7.AUSTRALIA'<?php is_selected1('AUSTRALIA', $country); ?>>AUSTRALIA</option>
                               <option value='7.CANADA'<?php is_selected1('CANADA', $country); ?>>CANADA</option>
                              <option value='7.SCOTLAND'<?php is_selected1('SCOTLAND', $country); ?>>SCOTLAND</option>
                              ...
                              <option value="1.12SW"<?php is_selected1('12B2', $zones); ?>>12B2 (L12 South West)</option>
                              ...
                              <optgroup label='Exam Prep'>
                               ...
                               <option value='8.TOIEC'<?php is_selected1('TOIEC', $exam_prep); ?>>TOIEC</option>
                              <option value='8.KET'<?php is_selected1('KET', $exam_prep); ?>>KET</option>
                              <option value='8.PET'<?php is_selected1('PET', $exam_prep); ?>>PET</option>
                              <option value='8.FCE'<?php is_selected1('FCE', $exam_prep); ?>>FCE</option>
                              <option value='8.CAE'<?php is_selected1('CAE', $exam_prep); ?>>CAE</option>
                              <option value='8.CPE'<?php is_selected1('CPE', $exam_prep); ?>>CPE</option>
                              <option value='8.TRINITY'<?php is_selected1('TRINITY', $exam_prep); ?>>TRINITY</option>
                              <option value='8.TOEFL'<?php is_selected1('TOEFL', $exam_prep); ?>>TOEFL</option>
                              <option value='8.IELTS'<?php is_selected1('IELTS', $exam_prep); ?>>IELTS</option>
                              </optgroup>
                            </select>
