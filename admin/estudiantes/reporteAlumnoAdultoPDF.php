  ...
  function DameClienteI($id)
	...
	function DameAlumnoI($id)
   {
	...
	$NecesitaMejorar=DameNecesitaMejorarI($id);
		...
		$pdf->SetXY(28,42); 
		$pdf->Cell(40,2,'Cliente: '.iconv('UTF-8', 'windows-1252', $Cliente),0,0,'L');
		
		
		$pdf->SetXY(28,52); 
		$pdf->Cell(40,2,'Alumno/a: '.iconv('UTF-8', 'windows-1252', $Alumno),0,0,'L');
		...
		// $material = htmlspecialchars($MaterialUsado, ENT_QUOTES);
...
//		$areas[7]='Comportamiento';
		...
		$pdf->MultiCell(160,5,'Comentarios: '.$coment,0,'L');
		
		//$necesito = htmlspecialchars($NecesitaMejorar, ENT_QUOTES);
		$necesito = utf8_decode($NecesitaMejorar);
		$pdf->SetXY(29,150+10+$ajuste+16+30); 
		$pdf->MultiCell(160,5,'Necesita mejorar: '.$necesito,0,'L');
