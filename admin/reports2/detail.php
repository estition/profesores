...
<html>
	<head>
		<link href="../Copia%20de%20reports/css/canterbury.css" type="text/css" rel="stylesheet">
		<title>Detail</title>
	</head>
 ...
 */
 ...
 $sql = "select b.id, day, name, observations, hours, concept_id, a.class_type, supplement from entry a, groups b ";
 $sql .= "where a.group_id = b.id and day >= '" . $_REQUEST['fromday'] . "' and day <= '" . $_REQUEST['today'] . "' and b.id = " . $_REQUEST['group_id'] . " and hours = " . $_REQUEST['hours'] . " and a.class_type = " . $_REQUEST['class_type'];
 $sql .= " and ( concept_id = 1 or concept_id = 3 )  order by day asc";
