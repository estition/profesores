...
$resultado = mysql_query($sql1) or die("Invalid query: " . mysql_error());
$row1 = mysql_fetch_array($resultado, MYSQL_ASSOC);
$selected = "selected";
...
<script>
	...
	function printWindow() {
		thewindow = window.open("", "Print", "width=800, height=600, location=no, menubar=no, status=no, toolbar=no, scrollbars=yes, resizable=yes");
	...
	if ($numRows > 0) {
		while ($row2 = mysql_fetch_array($result2, MYSQL_ASSOC)) {
			...
			//********************************************************************************************
				...
				$dates .=  $row['day'] . " ";
				}else if ($row2['class_type'] == 4and $row['concept_id']== 1){
				$dates .=  $row['day'] . " ";
				}
			...
			//********************************************************************************************		
					...
					$sql = "select price, type from prices where type = " . $row['class_type'] .  " and hours = " . $row['hours'];
			...
			//********************************************************************************************		
				...
				print "<td bgcolor='" . $bg ."'>&nbsp;</td>";
				print "<td bgcolor='" . $bg ."'><a href='/profesores/admin/clients/group_profile.php?id=" . $row2['id'] . "'>" . $row2["name"] . "</a></td>";
				print "<td bgcolor='" . $bg ."'>&nbsp;</td>";
