...
if ($_REQUEST['id'] == "") {
	...
	$sql0 = "select * from comp_groups where name = '". escape($_POST['name']). "'";
...
*/
				$sql = "insert into comp_groups (name, start, fecha_inicio, supplement, class_type, gender, days, seguimiento, objetivos, ninos, tcontry, nivel, preferencia, price) values ";
...
if ($id != "" && $_POST['action'] == "Add teacher") {
	...
	$message = "<br>Before to add a new teacher you must enter the end date!";
     ...
     $sql1 = "update comp_groups set active = 1, baja = 0 where id = " . $id;
	...
	$enddatebbdd = str_replace("-", "", $_POST['end_teacher'][$i] );
		...
		if ($act_teacher1){
			$sql = "update comp_groups set active = 0, baja = 0 where id = " . $id;
			mysqli_query($link, $sql) or die("Invalid query: " . mysqli_error($link));
	}else {$sql = "update comp_groups set active = 1, baja = 0 where id = " . $id;
			mysqli_query($link, $sql) or die("Invalid query: " . mysqli_error($link));}
...
$dias = implode(",", $array2string);}
   	...
   	$sql = "update groups set name = '".$_POST["name"]."', start= '".$_POST["start"]."', fecha_inicio= '".$_POST["start1"]."', supplement= '".$_POST["supplement"]."', class_type= '".$_POST["class_type"]."', gender= '".$_POST["gender"]."', days= '".$dias."', metro= '".$_POST["Metro"]."',  objetivos= '".$_POST["Objetivos"]."', seguimiento= '".$_POST['Seguimiento']."', ninos= '".$_POST["nino"]."', tcontry= '".$_POST["contry"]."', nivel= '".$_POST["nivel"]."', preferencia= '".$_POST["Preferencia"]."', price= ".$_POST["price"]." where id = " . $id;
...
if ($id != "" && $_POST['action'] == "Update info") {
	...
	$sql = "update comp_groups set active = 1, baja = 0 where id = " . $id;
			mysqli_query($link, $sql) or die("Invalid query: " . mysqli_error($link));}
}
...
if (($id != "") && (($message == "<br>Client Group Profile Saved.") || ($message == ""))) {
	...
	$sql = "select * from comp_groups where id = " . $id;
...
<td width="188"><span id="sprytextfield02">
...
<label><span class="style10">  
    ...
    <td width="253" rowspan="7"><label></label> 
         <fieldset>
 
   <label><span class="style9"><strong>Follow-up:</strong></strong><span id="countdown002"></span>
...
onKeyUp="limitText(this.form.Seguimiento,'countdown002',1000);"><?php echo  $Seguimiento;?></textarea>
  ...
  <label><span class="style9"><strong>Objective:</strong></strong><span id="countdown001"></span>
  <div class="textareaRequiredMsg"><font size="2">Required</font></div></span><br />
  <textarea name="Objetivos" id="Objetivos" cols="35" rows="5" onKeyDown="limitText(this.form.Objetivos,'countdown001',1000);" 
onKeyUp="limitText(this.form.Objetivos,'countdown001',1000);"><?php echo  $Objetivos;?></textarea>
  </label>
  </span>
    </fieldset> <fieldset>
 <label><span class="style6 style9 style7"><strong>Kids?</strong></span>
 
 <input type="checkbox" name="nino" value="1" <?php  if($nino == "1") echo 'checked="checked"' ?>  />
 </label> 
 
 <label><span class="style6 style9 style7"><strong>USA</strong></span>
 
 <input name="contry" <?php echo  $button1;?> type="radio" value="USA" /> 
 </label>

 <label><span class="style6 style9 style7"><strong>UK</strong></span>
 
 <input name="contry" <?php echo  $button2;?> type="radio" value="UK" /> 
 </label>
 
 <label><span class="style6 style9 style7"><strong>H</strong></span>
 
 <input name="gender" <?php echo  $button3;?> type="radio" value="H"/> 
 </label>  
 
 <label><span class="style6 style9 style7"><strong>M</strong></span>
...
?> 
 ...
 <label><span class="style6 style9 style7"><strong>Nivel</strong></span>
 ...
 <span id="sprytextarea2">
   ...
   <label><span class="style9"><strong>Preference:</strong></strong><span id="countdown003"></span>
...
?> 
  ...
  <tr>
    <td>Supplement:       </td>
    <td colspan="2"><input name="supplement" id="supplement" size="5" type="text" value="<?php echo  $supplement;?>">
      Amount teachers recieve for this client.</td>
    </tr>
  <tr>
  <td height="21">Price:</td>
    <td colspan="2"><span id="sprytextfield01">
 ...
 <?php
	...
	$dd = intval(substr($start,8,2));
	  ...
	  $myCalendar->setYearSelect(2011, 2013);
	  $myCalendar->dateAllow('2011-01-01', '2013-12-31');
...
?>  
 ...
 <fieldset>
   ...
   <select name="teacher_id">
     <?php echo $teachers?><br />
	  ...
	  $myCalendar3->setYearSelect(2011, 2013);
	  $myCalendar3->dateAllow('2011-01-01', '2013-12-31');
 ...
 <input name="action" type="submit" class="boldText" id="action" value="Add teacher" />      
    ...
    <tr>
                      	<td bgcolor="#eeeeee" colspan="4"><table width="665" border="0" align="center" bgcolor="#eeeeee">
                <tr> 
...
if ($numRows > 0) {
   ...
   <select name='hora_fin1[]' id='hora_fin1' >
							   ...
							   <option value=09:00 '".is_selected_fin('09:00')."'>09:00</option>
								...
								<option value=21:30 '".is_selected_fin('21:30')."'>21:30</option>
                                <option value=22:00 '".is_selected_fin('22:00')."'>22:00</option>
                                </select></td>";
