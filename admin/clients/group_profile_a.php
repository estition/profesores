...
if (($id != "") && (($message == "Client Group Profile Saved.") || ($message == ""))) {
...
?> 
 ...
 <select name="est_cli" size="1" id="est_cli" accesskey="L" tabindex="0">
   ...
   <option value="Substitución"<?php is_selected4('Substitución'); ?>>Substitución</option>
...
?> 
 ...
 <select name="class_type" size="1" id="class_type" accesskey="L" tabindex="0">
   <option value="">---------------------------</option>
   <option value="1"<?php is_selected2('1'); ?> >Individual   (13€)</option>
   <option value="2"<?php is_selected2('2'); ?>>Grupo I   (15€)</option>
   <option value="3"<?php is_selected2('3'); ?>>Grupo II   (18€)</option>
    </select>   
    </label>
 <span class="selectRequiredMsg"><font size="2">Required</font></span></span> </td>
  </tr>
