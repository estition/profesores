...
if($_REQUEST['identificador']!="")
	{	
	$identificador= explode(",", $_REQUEST['identificador']);
	//$correos="";
	//print_r($identificador);
	$enlaces="";
	//$cont_id=0;
		for( $d = 0; $d < count($identificador); $d++){
			//echo $identificador[$d]."EE";
			if ($identificador[$d]!= NULL or $identificador[$d]!=""){
				$query= "select ID, email from groups where ID='".$identificador[$d]."'";
				//echo $query."EE";
		      ...
		      <TR>
                ...
                <TABLE border="0"><!-- TABLE INT -->
			      <TR>
		            ...
		            <TD width="443" style="padding-right:2em"><input type="text" name="from" id="from" size="60" value="info@canterburyenglish.com" disabled></TD>
			      </TR>
			      <TR>
