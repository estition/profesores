...
if (($id != "") && (($message == "<br>Client data updated.") || ($message == ""))) {
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" id="body">
...
<table width="481" border="0" align="center" bgcolor="#eeeeee">
