            ...
            ?>
				...
				$cont=1;
           		while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {					
					echo "<tr>";
					echo "<td>".$contador.". </td>";					
					echo "<td>".addZero($row['DIA_INFORME'])."/".addZero($row['MES_INFORME'])."/".$row['A�O_INFORME']."</td>";
					if ($is_admin_a) {
						switch ($row['status']) {
						case 0:
...
///////////////////////////////////
        ...
        <tr valign="top"> 
        	<td colspan="12" bgcolor="#eeeeee" align="right">
            	<?php if ($is_admin_a) { echo "Emails ready for send: ".$cont; ?> 
