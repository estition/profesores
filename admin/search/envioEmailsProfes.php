...
// echo $_REQUEST['identificador']."vvvvv";
if($_REQUEST['identificador']!="" and $attach !="Attach File")
	{	
	...
	$cont_id=0;
				...
				$query= "select id, email from users where id REGEXP '(,|^){$identificador}(,|$)'";
				//echo $query;
...
if ( ($enviar =="Send") && ($infoValida) ){
	...
	//echo $_REQUEST['correos']."cccc";
	$correos1 = explode(",", $_REQUEST['correos']);
$mensaje=$mensaje." ".EnviarCorreo($correos1,$asunto,$mensaje_mail,$mensaje_mail_html,$file_source, $files);
...
<TD width="600" valign="top">
          ...
          <form method="post" enctype="multipart/form-data" action="envioEmailsProfes.php" name="enviar_mail" id="enviar_mail">
		      ...
		      <TR>
                ...
                <TABLE border="0"><!-- TABLE INT -->
			      ...
			      <TR>
		            ...
		            <TD style="padding-right:2em"><input type="text" name="correos" id="correos" size="60" value="<?php echo $correos;?>">
                  ...
                  <span id="sprytextarea1">
		               ...
		               <textarea name="mensaje_mail" id="mensaje_mail" rows="20" cols="60" > <?php echo $mensaje_mail;?></textarea>
                        <div class="textareaRequiredMsg">Required</font></div>
		              </span>                     
                     
                 </TD></TR>	
                         
                  <TR>
                    <TD colspan="2"><p><span class="style14">Attached File(s):</span><?php if(!empty($files)){foreach($files as $reg){ echo " <br>".$reg;}}?></p></TD></TR>                 
