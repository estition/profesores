			...
			?>
				...
				<td height="500" bgcolor="B6C5F2" width="130px" valign="top" >
                    ...
                    <tr><td class="menuText" bgcolor="#<?php echo isSelected("calendar", $page_name);?>" style="cursor:pointer" onMouseOver="javascript:this.style.background='#738FE6'" onMouseOut="javascript:this.style.background='#<?php echo isSelected("calendar", $page_name);?>'"><a href="/profesores/calendar.php">- My Calendar</a></td></tr>
