...
if ( ($_REQUEST['id'] == "") && ($infoValida) ) {
	...
	if ($_POST['action'] == "Save changes") {
		...
		if ($message == "") {
			...
			$A�o=date("Y"); $Dia=date("d"); $Mes=date("m");
				  $sql = "insert into informes_alumnos2 ( ";
				  $sql = $sql." DIA_INFORME, MES_INFORME, A�O_INFORME, IDCLIENTE, IDUSUARIO, PRONUNCIACION, GRAMATICA, COMPRENSION_ORAL, COMPRENSION_ESCRITA, EXPRESION_ORAL, EXPRESION_ESCRITA, PARTICIPACION, COMPORTAMIENTO, OTROS_COMENTARIOS, IDNIVEL, DURACION_CLASE, NECESITA_MEJORAR, IDTIPO_INFORME, IDCURSO, MATERIAL_USADO, ALUMNO, IDALUMNO, email, totalHours "   /* COMENTARIO1, COMENTARIO2, COMENTARIO3, COMENTARIO4, COMENTARIO5, COMENTARIO6, COMENTARIO7, COMENTARIO8*/ ;  										//.DameIdUsers($user_id). //.$_POST['$txtIdUsuario'].	//$txtIdUsuario
			      $sql = $sql.') values ('.$Dia.','.$Mes.','.$A�o.','.$txtIdCliente.','.DameIdUsers($user_id).','.$_POST['GrupoOpciones1'].','.$_POST['GrupoOpciones2'].','.$_POST['GrupoOpciones3'].','.$_POST['GrupoOpciones4'].','.$_POST['GrupoOpciones5'].','.$_POST['GrupoOpciones6'].','.$_POST['GrupoOpciones7'].','.$_POST['GrupoOpciones8'].',"'.$_POST['txtOtrosComentarios'].'",'.$_POST['txtIdNivel'].',"'.$_POST['txtDuracionClase'].'","'.$_POST['txtNecesitaMejorar'].'","'.$_POST['txtIdTipoInforme'].'","'.$_POST['txtIdCurso'].'","'.$_POST['txtMaterialUsado'].'","'.$alumno.'","'.$idalumno.'","'.$email.'","'.$_POST['totalHours']. /* '","'.$_POST['txtComentarios1']. '","'.$_POST['txtComentarios2']. '","'.$_POST['txtComentarios3']. '","'.$_POST['txtComentarios4']. '","'.$_POST['txtComentarios5']. '","'.$_POST['txtComentarios6'].'","'.$_POST['txtComentarios7']. '","'.$_POST['txtComentarios8']. */'")';		
...
if ( ($id != "") && ($_POST['action'] == "Save changes") && ($infoValida) ) {
	...
	if ($message == "") {	//$A�o=date("Y"); $Dia=date("d"); $Mes=date("m");
		...
		$sql = $sql . ", OTROS_COMENTARIOS = '" . $_POST['txtOtrosComentarios'] . "', MATERIAL_USADO = '" . $_POST['txtMaterialUsado'] . "' ";
		$sql = $sql . ", NECESITA_MEJORAR = '" . $_POST['txtNecesitaMejorar'] . "' " ;
		...
		if ($is_admin_a) {		
			...
			$sql = $sql . ", adminComments = '" .$_POST['adminComments'] . "' " ;
		} else {
			$sql = $sql . ", status = 0 " ;
...
<script type="text/javascript">
	function validar(){
		...
		if (document.getElementById("totalHours").value==""){
			x = 0; cadena += " - Enter total hours of class.\n";
		} else {
			if ( validarEntero(document.getElementById("totalHours").value)=="" ){
				x = 0; cadena += " - Enter a valid total hours of class.\n";
			}
		}
...
Adult comment's must be in english<br />Children comment's must be in spanish</p>
                 ...
                 <table border="0" class="pepe1" cellpadding="5" align="center" bgcolor="#ccc" cellspacing="0" id="login">
                     ...
                     <tr> 
                      ...
                      <tr> 
                        ...
                        <td><input id="totalHours" name="totalHours" type="text" maxlength="5" size="5" value="<?php echo  $totalHours;?>" /></td>
                      </tr>
                      <tr> 
                        <td valign="top"><b>*Duration of each class:</b></td>
                        <td><input id="txtDuracionClase" name="txtDuracionClase" type="text" maxlength="5" size="5" value="<?php echo  $txtDuracionClase;?>" /></td>
                      </tr>
                      <tr>                        
                      ...
                      <tr>
                              ...
                              <td><textarea name="txtOtrosComentarios" cols="50" wrap="virtual" id="txtOtrosComentarios"  onKeyDown="limitText(this.form.txtOtrosComentarios,'countdown002',1000);" onKeyUp="limitText(this.form.txtOtrosComentarios,'countdown002',1000);"><?php echo  $txtOtrosComentarios;?></textarea><span id="countdown002"></span></td>
                            </tr>
							<tr> 
                              <td valign="top"><b>*Material Used:</b><br />
                                In English</td>
                              <td>                                <p>
                                <textarea name="txtMaterialUsado" cols="50" wrap="VIRTUAL" id="txtMaterialUsado"  onKeyDown="limitText(this.form.txtMaterialUsado,'countdown001',1000);" onKeyUp="limitText(this.form.txtMaterialUsado,'countdown001',1000);"><?php echo  $txtMaterialUsado;?></textarea><span id="countdown001"></span>
                              </p>                              </td>
                            </tr>
							<tr> 
                              ...
                              <td>                                <p>
                                <textarea name="txtNecesitaMejorar" cols="50" wrap="VIRTUAL"  onKeyDown="limitText(this.form.txtNecesitaMejorar,'countdown000',1000);" onKeyUp="limitText(this.form.txtNecesitaMejorar,'countdown000',1000);"><?php echo  $txtNecesitaMejorar;?></textarea><span id="countdown000"></span>
                              </p>                              </td>
                            </tr>
         ...
         <?php if ($is_admin_a) {	?>
                      ...
                      <tr> 
                        ...
                        <td><p>
                        	<textarea id="adminComments" name="adminComments" cols="50" wrap="VIRTUAL"  onKeyDown="limitText(this.form.adminComments,'countdown003',1000);" onKeyUp="limitText(this.form.adminComments,'countdown003',1000);"><?php echo  $adminComments;?></textarea><span id="countdown003"></span>
                        </p></td>
                      </tr>
