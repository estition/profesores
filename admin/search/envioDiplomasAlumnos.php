...
"; //trim(substr($correos,1))
		//$enlaces = "\n\n<!-- ATTENTION, DO NOT MODIFY OR DELETE THE NEXT CODE. -->\n<br />A continuación ponemos a su disposición un enlace al fichero anteriormente mencionado: &nbsp;<a href=http://www.canterburyenglish.com/SolicitudInscripcion.doc alt='Solicitud de inscripción' target='_blank'>Solicitud de inscripción</a>, <br />Recuerde rellenar este formato y enviarlo como archivo adjunto vía e-mail a la dirección <b>coordinacion@canterburyenglish.com</b>.<br /><br />\n<!-- END OF CODE -->"; //*Important: This is an automatically generated e-mail, please do not reply to this address.
